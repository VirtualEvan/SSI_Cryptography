...
public class JSONUtils {
    ...
    public static final void main(String[] args) {
        ...
        datos.put("nombre", "Vikor Va Arriba");
        datos.put("dni", "86152445K");
        datos.put("domicilio", "Su casa");
        datos.put("fecha", "28/09/16");
        datos.put("lugar", "Ourense");
        datos.put("motivacion", "Ayer comencé a vivir una vida loca, super loca, requete loca, llegué a a la disco y me pasé de copas, entré con una, y salí con otra.");
